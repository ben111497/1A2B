...
import com.example.wordle_1A2B.databinding.ItemListBinding
import com.example.wordle_1A2B.api.AttractionsClassRes
import com.example.wordle_1A2B.tools.AsyncImageLoader

class ListAdapter(context: Context, private val list: ArrayList<AttractionsClassRes.Data>)
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (position >= list.size) return view
