package com.example.app_1A2B.ui.component.fragment.game.game
...
import com.example.app_1A2B.databinding.FragmentGameBinding
import com.example.app_1A2B.helper.*
import com.example.app_1A2B.ui.base.BaseFragment
import com.example.app_1A2B.ui.component.adapter.GameAdapter
import com.example.app_1A2B.ui.component.dialog.game.GameDialog
import com.example.app_1A2B.ui.component.dialog.game.GameHintDialog
import com.example.app_1A2B.ui.component.dialog.show_message.ShowMessageDialog
    ...
    override fun observeViewModel() {
        ...
        observe(viewModel.isDialogOn) {
            if (it) {
                ...
                requireActivity().showToast("獲得 ${viewModel.winCoin}金幣")
            }
        }
            ...
            ShowMessageDialog<ViewModel> {
                ...
                it.setListener(object: ShowMessageDialog.Listener {
                    override fun onOk() {
                        ...
                        it.dismiss()
                        Navigation.findNavController(binding?.root ?: return).popBackStack(R.id.homePageFragment, false)
                        requireActivity().showToast("失去 50金幣")
                    }
                })
